    ...
    <div class="tab-list___container">
        <div class="tab-list">
            <div class="tab-list__item">
                <a href="/application_list?tab=unapproved" class="tab-list__unapproved {{ request('tab') === 'unapproved' ? 'active' : '' }}">承認待ち</a>
            </div>
            <div class="tab-list__item">
                <a href="/application_list?tab=approved" class="tab-list__approved {{ request('tab') === 'approved' ? 'active' : '' }}">承認済み</a>
            </div>
        </div>
    </div>
    <table class="application_table">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="/attendance/{{ $application->attendance->id }}" class="attendance__detail-link">詳細</a>
                @endif
            </td>
        </tr>
        @endforeach
